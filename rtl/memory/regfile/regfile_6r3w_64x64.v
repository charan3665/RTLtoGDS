// ============================================================
// regfile_6r3w_64x64.v - 6R3W Register File (64x64)
// ============================================================
`timescale 1ns/1ps

module regfile_6r3w_64x64 #(
    parameter DEPTH     = 64,
    parameter WIDTH     = 64,
    parameter NRP       = 6,  // read ports
    parameter NWP       = 3   // write ports
)(
    input  wire                     clk,
    input  wire                     rst_n,
    // Read ports
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) for(i=0;i<64;i=i+1) mem[i]<={64{1'b0}};
